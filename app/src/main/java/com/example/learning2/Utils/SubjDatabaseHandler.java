...
public class SubjDatabaseHandler extends SQLiteOpenHelper {
    ...
    public SubjDatabaseHandler(Context context) {
    ...
    public void deleteSubject(int id1){
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_NAME , COLUMN_ID+ "= ?", new String[] {String.valueOf(id1)});
